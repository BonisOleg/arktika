...
# django-docker-ssl: до certbot/домену — HTTP-only деплой (USE_HTTPS=False), інакше
# внутрішній /healthz/ (без X-Forwarded-Proto) отримує 301 і healthcheck падає.
# Виставити USE_HTTPS=True в .env лише після certbot і nginx docker.prod.conf.
